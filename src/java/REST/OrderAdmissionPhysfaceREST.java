...
import logic.dao.OrderAdmissionPhysfaceDAO;
...
@Path("OrderAdmissionPhysface")
public class OrderAdmissionPhysfaceREST {
    private OrderAdmissionPhysfaceDAO orderdao;

    public OrderAdmissionPhysfaceDAO getOrderDAO() {
        return orderdao;
    }

    public void setOrderDAO(OrderAdmissionPhysfaceDAO orderado) {
    ...
    public String getOrderList() throws NamingException, SQLException{
        orderdao=new OrderAdmissionPhysfaceDAO();
    ...
    public String insertOrder(String orderjson){
        ...
        try {
            ...
            Logger.getLogger(OrderAdmissionPhysfaceREST.class.getName()).log(Level.SEVERE, null, ex);
